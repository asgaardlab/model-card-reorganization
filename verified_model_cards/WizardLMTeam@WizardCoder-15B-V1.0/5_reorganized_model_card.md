...
### Motivation:
To evaluate the performance of Code LLMs and Math LLMs on code generation and math problem solving tasks.
Comparing WizardCoder with Closed-Source and Open-Source Models.
...
### Motivation:
To improve the code generation capabilities of the model using Evol-Instruct method.
...
### Known model use cases that are especially fraught:
Not available.

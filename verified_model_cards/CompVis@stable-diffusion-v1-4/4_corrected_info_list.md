...
- Code snippet for loading in bfloat16 precision from "bf16" branch:
    ```python
    import jax
    import numpy as np
    from flax.jax_utils import replicate
...
- Note: This section is taken from the [DALLE-MINI model card](https://huggingface.co/dalle-mini/dalle-mini), but applies in the same way to Stable Diffusion v1_.
